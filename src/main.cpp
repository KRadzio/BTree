...
int main()
{
    ...
    // BTree::GetInstance().Delete(29);
    // BTree::GetInstance().Delete(49);
    // BTree::GetInstance().Delete(5);
    // BTree::GetInstance().Delete(7);
    // BTree::GetInstance().Delete(32);
    // BTree::GetInstance().Delete(39);
